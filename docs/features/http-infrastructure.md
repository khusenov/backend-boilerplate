...
| `JWT_ISSUER`                  | `app` (from `APP_NAME`)                                 | JWT `iss` claim. See [Authentication](./authentication.md).                                                                |
| `JWT_AUDIENCE`                | `app-api` (from `APP_NAME`)                             | JWT `aud` claim. See [Authentication](./authentication.md).                                                                |
...
| `QUEUE_PREFIX`                | `app` (from `APP_NAME`)                                 | BullMQ key prefix. See [Background Jobs](./background-jobs.md).                                                            |
...
| `OTEL_SERVICE_NAME`           | `app-api` (from `APP_NAME`)                             | Service name; also the `service` field `toServiceIdentity` stamps onto logs. See [Tracing](./tracing.md).                  |
...
| `EMAIL_FROM`                  | `—` (devDefault `no-reply@<APP_NAME>.local`)            | Default `From` address. See [Email Sending](./email-sending.md).                                                           |
